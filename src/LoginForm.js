...
// url 주소 달라도 서로 AJAX 통신으로 접근할 수 있도록 허용
...
export default class LoginForm extends Component {
  ...
  join = () => {
    ...
    if (joinPw.match(regExp2) === null || joinPw.match(regExp2) === undefined) {
    ...
    axios
      .post("http://localhost:8080/member/join", sendParam)
      // 정상 수행
      .then((returnData) => {
  ...
  login = () => {
    ...
    axios
      .post("http://localhost:8080/member/login", sendParam)
      .then((returnData) => {
        if (returnData.data.message) {
